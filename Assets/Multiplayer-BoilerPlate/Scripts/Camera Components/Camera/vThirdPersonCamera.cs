...
public class vThirdPersonCamera : CameraController
{
    ...
    private CinemachineCamera m_CinemachineVirtualCamera;
    ...
    public void Init()
    {
        ...
        m_CinemachineVirtualCamera = GetComponent<CinemachineCamera>();
    ...
    private void Update()
    {
        if(this.shiftFov)
        {
            m_CinemachineVirtualCamera.Lens.FieldOfView = Mathf.Lerp( m_CinemachineVirtualCamera.Lens.FieldOfView, this.targetFov, this.valueShiftRate * Time.deltaTime);
            if ( m_CinemachineVirtualCamera.Lens.FieldOfView== this.targetFov)
                this.shiftFov = false;
        }
    }
